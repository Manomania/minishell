...
/*   Updated: 2025/05/06 14:32:23 by elagouch         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_bool		process_word_token_case(t_command *cmd, t_token **current,
				t_ctx *ctx, t_bool *first_arg_processed);

// command_parse_utils2.c
int			handle_redirection_token(t_command *cmd, t_token *token,
				t_token *next_token, t_ctx *ctx);
t_bool		handle_empty_first_arg(t_command *cmd, t_token **current,
				t_ctx *ctx);
